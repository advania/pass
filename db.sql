Do not run this as a sql file directly, this line is intentionally a syntax error.

Run these commands as a super user on the database server.
...
-- You have to switch to it for the rest of the queries
\c passwords

-- After connecting to this database, you can run this entire rest in one transaction
begin;
